...
for lat in lats:
    for lng in lngs:
        print(lat,lng)
        url='https://maps.googleapis.com/maps/api/place/nearbysearch/json?location='+str(lat)+','+str(lng)+'&radius=110000&type=hospital&country=India&key='+os.environ.get("API_KEY")
